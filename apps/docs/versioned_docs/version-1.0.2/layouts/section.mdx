...
sidebar_position: 2
title: Section
description: A flexible layout component for creating content sections with customizable spacing, backgrounds, padding, and max-width constraints.
---
...
import SectionDemo from '@site/src/components/Demo/SectionDemo';
...
<Tabs>
  ...
  <TabItem value="yarn" label="yarn">
    ```bash
    yarn @mindfiredigital/ignix-ui add section
    ```
  </TabItem>
  <TabItem value="pnpm" label="pnpm">
    ```bash
    pnpm @mindfiredigital/ignix-ui add section
    ```
  </TabItem>
