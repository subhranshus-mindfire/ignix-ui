  ...
  <TabItem value="preview" label="Preview" default>
    <div className="p-4 border rounded-lg flex justify-center">
      <AspectRatio ratio="16:9" maxWidth="400px">
        <img src="https://picsum.photos/800/450" alt="Demo Image" className="object-cover w-full h-full" />
      </AspectRatio>
    </div>
  </TabItem>
...
function BasicAspectRatio() {
  return (
    <AspectRatio ratio="4:3" maxWidth="500px">
      <img src="https://picsum.photos/600/450" alt="Demo Image" className="object-cover w-full h-full" />
    </AspectRatio>
  );
}
```
