...
export function CTASection() {
    return (
        <section className="w-full pt-20 md:pt-60 lg:pt-60 pb-10 md:pb-20 px-5 relative flex flex-col justify-center items-center overflow-visible">
          ...
          border-[color-mix(in_oklab,var(--foreground),_transparent)]
            ...
            ">
                ...
                " />
                        ...
                        <p className="text-foreground text-lg md:text-xl font-medium leading-relaxed max-w-3xl">
                            Join{" "}
                            <span className="text-foreground font-semibold px-2 py-1 rounded-md
                bg-[color-mix(in_oklab,var(--primary),_transparent)]
              ">
                                thousands of developers
                            </span>{" "}
                            who are building faster, shipping sooner, and creating{" "}
                            <span className="text-[var(--primary)] font-semibold">better user experiences</span> with Ignix UI.
                        </p>
                    </div>
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-2">
                        <Link to="/docs/components/button">
                            <Button
                                className="
                  px-8 py-3 rounded-full text-lg font-semibold text-primary-foreground
