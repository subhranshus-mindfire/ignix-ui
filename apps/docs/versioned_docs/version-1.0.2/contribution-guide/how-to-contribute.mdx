...
## Table of Contents
  ...
  - [Contribution Workflow](https://www.google.com/search?q=%23contribution-workflow)
      ...
      - [3. Develop in Storybook (The Fun Part\!)](https://www.google.com/search?q=%233-develop-in-storybook-the-fun-part)
      - [4. Register Your Component](https://www.google.com/search?q=%234-register-your-component)
      - [5. Add Documentation](https://www.google.com/search?q=%235-add-documentation)
      - [6. Write Unit Tests](https://www.google.com/search?q=%236-write-unit-tests)
      - [7. Commit and Push Your Changes](https://www.google.com/search?q=%237-commit-and-push-your-changes)
      - [8. Create a Pull Request](https://www.google.com/search?q=%238-create-a-pull-request)
...
### 7\. Commit and Push Your Changes
  ...
  - **Stage and Commit:** Add your changes and write a clear, descriptive commit message that follows the [Conventional Commits](https://www.conventionalcommits.org/en/v1.0.0/) specification.
    ```bash
    git add .
    git commit -m "feat(avatar): add new avatar component with storybook and tests"
    ```
  - **Push to Your Fork:**
    ```bash
